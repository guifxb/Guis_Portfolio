...
import com.example.guisportfolio.model.defaultUser
...
fun pdfModel(context: Context, movies: List<MovieInfoLocal>): PdfDocument {
    ...
    //Background painting
    val background = context.resources.getColor(R.color.pdf_background, null)
    paint.color = background
    canvas.drawColor(paint.color)

    //Painting the separator
    paint.color = context.resources.getColor(R.color.md_theme_light_onPrimaryContainer, null)
    paint.strokeWidth = 2f
    canvas.drawLine(200f, 0f, 200f, 842f, paint)
    canvas.drawLine(204f, 0f, 204f, 842f, paint)
    paint.color = context.resources.getColor(R.color.md_theme_light_surfaceTint, null)
